...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Nearest reduced-phase KKT cost, kJ mol-O⁻¹ | 78.44 | 62.92 | 54.74 | 46.17 | 37.03 | 27.30 |
...
Production values are stored in `data/reference_results_high_precision.json`. Legacy regression values, including the incomplete CH4 case, are stored in `data/results.json`.
