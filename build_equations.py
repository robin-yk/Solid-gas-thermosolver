...
# row kinds: title, sub, head, eq (math, number), note, gap
R = []
...
R.append(('eq', r'$|r_j| / d_j < \varepsilon_{\mathrm{deg}} \ \Rightarrow\ \mathrm{degenerate\ boundary\ (reported,\ never\ resolved\ by\ fiat)}$', '23'))
...
R.append(('note', r'every $\mathrm{TiO_2} \rightarrow$ Magnéli step has $d_j = 1$ — the accident that made the two bases coincide in earlier work'))
